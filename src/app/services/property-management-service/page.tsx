...
const INCLUDED_ITEMS = [
  "Rent collection tracking and periodic payment updates.",
  "Tenant communication support for day-to-day issues.",
  "Maintenance coordination with trusted local vendors.",
  "Regular owner reports on occupancy, expenses, and property status.",
];
    ...
    <div className="flex flex-1 flex-col items-center bg-[#f2f1ef] px-6 py-16 font-sans text-foreground">
      <RevealOnScroll className="w-full max-w-5xl border border-[#e0ded9] bg-[#f9f9f7] p-8 shadow-sm sm:p-10">
        ...
        <p className="mt-6 text-base leading-8 text-foreground/80">
          We provide end-to-end property management so you don't have to worry
          about day-to-day operations. From rent collection and tenant
          coordination to maintenance and regular updates, we ensure your
          property is well-maintained and performing optimally while you stay
          stress-free, no matter where you are.
        </p>
